          ...
          <div className="xl:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 transition-all outline-none"
                ...
                {/* ACTIVE ITEM FORM */}
                {currentItem && (
                  <div className="bg-brand-50/40 dark:bg-brand-950/20 rounded-2xl p-6 border border-brand-100 dark:border-brand-900/50 animate-in fade-in slide-in-from-top-4 duration-300">
                    <div className="flex items-center justify-between mb-5 border-b border-brand-100/50 dark:border-brand-900/30 pb-3">
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 bg-brand-600 rounded-lg flex items-center justify-center">
                          <Package className="h-5 w-5 text-white" />
                        </div>
                        <div>
                          <h4 className="font-bold text-brand-900 dark:text-brand-400">{currentItem.medicineName}</h4>
                          <p className="text-xs text-brand-600 dark:text-brand-500 font-medium uppercase">{currentItem.form}</p>
                        </div>
                      </div>
                      <button onClick={() => setCurrentItem(null)} className="p-2 hover:bg-red-50 dark:hover:bg-red-950/30 text-gray-400 hover:text-red-500 rounded-lg transition-colors">
                        <X className="h-5 w-5" />
                      </button>
                    </div>
                          ...
                          <input
                            ...
                            className={cn(
                              ...
                              isBatchAutoGenerated
                                ...
                                : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500",
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 overflow-hidden relative">
              ...
              <div className="space-y-5">
                ...
                <textarea
                  ...
                  className="w-full p-4 rounded-xl border border-gray-200 dark:border-gray-700 text-sm outline-none focus:ring-2 focus:ring-brand-500 transition-all bg-gray-50 dark:bg-gray-950"
